	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'battle-primary': 'hsl(var(--battle-primary))',
				'battle-secondary': 'hsl(var(--battle-secondary))',
				'battle-success': 'hsl(var(--battle-success))',
				'battle-danger': 'hsl(var(--battle-danger))',
				'battle-warning': 'hsl(var(--battle-warning))',
