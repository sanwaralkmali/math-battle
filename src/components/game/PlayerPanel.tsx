...
export const PlayerPanel = ({
  ...
  return (
    <motion.div
      className={`game-card p-3 sm:p-6 ${bgGradient} ${
        player.isActive
          ? `${borderColor} border-4 ring-2 ring-${playerColorClass} ring-opacity-60 shadow-lg shadow-${playerColorClass}/30 animate-pulse`
          : ""
      } 
                  ${
                    isLastChance
